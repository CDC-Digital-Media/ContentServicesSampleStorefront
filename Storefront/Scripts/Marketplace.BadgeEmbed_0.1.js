...
//badge EMBED IS THE EMBED CODE (TAB) AND TABS SETUP

(function ($) {
    var PLUGIN_NAME = 'badgeEmbed';
    ...
    $.fn[PLUGIN_NAME] = function (options) {
        ...
        function main() {
            ...
            var $divPreview = $("<div class='badgePreviewPane'>");
        ...
        function setupTabs() {
            ...
            $ul.append("<li class='active'><a href='#' class='previewTab'>Badge Preview</a></li>");
        ...
        function showPreview() {
            ...
            $(".badgePreviewPane").show();
            $(".embedForm").hide();
            $(".badgePreviewPane").showSpinner();

            $(".badgePreviewPane").badge({
        ...
        function showEmbedForm() {
            ...
            $(".badgePreviewPane").hide();
            $(".embedForm").show();

            if ($(".embedForm").html() === '') {// just load form once.

               $(options.target).find(".embedForm").load("templates/badgeEmbedForm.htm", function () { setupEmbedForm(); });
        ...
        var generateCodeBlock = function () {
            ...
            codeBlock += '<script src="' + urlRoot + '/Scripts/Marketplace.badge_0.1.js" type="text/javascript"></script>\r';
            codeBlock += '\r';
            ...
            codeBlock += '$(".CDCHtmlContent_' + options.mediaItem.mediaId.toString() + '").badge({\r';
        ...
        var generateRawCodeBlock = function () {
            ...
            codeBlock += $(".badgePreviewPane").html();
            $preEmbed.text(codeBlock);
