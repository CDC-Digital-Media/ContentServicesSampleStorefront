...
(function ($) {
    var PLUGIN_NAME = "removeFromSyndicationList";
    ...
    $.fn[PLUGIN_NAME] = function (options) {
        ...
        function main() {
            ...
            $.ajax({
                type: "POST",
                url: "Secure.aspx/RemoveMediaFromSyndicationList",
                ...
                success: function (response) {
                    ...
                    if (obj.meta.status === 200) {
                        options.context.SelectedList.selectedMediaIds = jQuery.grep(options.context.SelectedList.selectedMediaIds, function (value) {
                            return value != options.mediaId;
                        });
                        ...
                        //handleComplete();
                        options.addHandler(options.mediaId);
                    }
