...
//button EMBED IS THE EMBED CODE (TAB) AND TABS SETUP

(function ($) {
    var PLUGIN_NAME = 'buttonEmbed';
    ...
    $.fn[PLUGIN_NAME] = function (options) {
        ...
        function main() {
            ...
            var $divPreview = $("<div class='buttonPreviewPane'>");
        ...
        function setupTabs() {
            ...
            $ul.append("<li class='active'><a href='#' class='previewTab'>Button Preview</a></li>");
        ...
        function showPreview() {
            ...
            $(".buttonPreviewPane").show();
            $(".embedForm").hide();
            $(".buttonPreviewPane").showSpinner();

            $(".buttonPreviewPane").button({
        ...
        function showEmbedForm() {
            ...
            $(".buttonPreviewPane").hide();
            $(".embedForm").show();

            if ($(".embedForm").html() === '') {// just load form once.

               $(options.target).find(".embedForm").load("templates/ButtonEmbedForm.htm", function () { setupEmbedForm(); });
        ...
        var generateCodeBlock = function () {
            ...
            codeBlock += '<script src="' + urlRoot + '/Scripts/Marketplace.button_0.1.js" type="text/javascript"></script>\r';
            codeBlock += '\r';
            ...
            codeBlock += '$(".CDCHtmlContent_' + options.mediaItem.mediaId.toString() + '").button({\r';
        ...
        var generateRawCodeBlock = function () {
            ...
            codeBlock += $(".buttonPreviewPane").html();
            $preEmbed.text(codeBlock);
